 <legend style="position: static;"><a href="<?php echo site_url('rekomendasiImb'); ?>">Data Perizinan IMB</a></legend>
	  <div class="static" style="position: relative; overflow: hidden">
		   ...
		   <div class="alert alert-success">
			      				...
			      				<strong>Permohonan Izin Mendirikan Bangunan</strong>.
			  </div>
				  ...
				  <td>
					<?php
						...
						if ($jumlahIzin > 0) {
							...
							?>
								<a class="label label-important" href="<?php echo site_url('arsip_imb/arsip_detail/1/'.$enkrip);?>">Arsip Izin</a> 
							<?php
						}
					?>
					<?php
						...
						if ($jumlahReko > 0) {
							...
							?>
								<a class="label label-important" href="<?php echo site_url('arsip_imb/arsip_detail/0/'.$enkrip);?>">Rekomendasi</a> 
							<?php
						}	
					?>
					...
					<?php
						...
						if ($syarat > 1) {
							?>
								<a class="label label-success" href="<?php echo site_url('arsip_imb/view_arsip/'.$enkrip); ?>">Arsip Lengkap</a> 
							<?php
						} else {
							?>
