 <legend style="position: static;"><a href="<?php echo site_url('rekomendasiImb'); ?>">Daftar Rekomendasi IMB</a></legend>
				  ...
				  <td><?php echo $nm_kelurahan;?></td>
				   ...
				   <?php
					if (!empty($statusCetak)) {
						?>
						<td><a href="<?php echo site_url('cetak_imb/cetak_detail/'.$enkrip);?>">Cetak</a> </td>
						<?php
					}
					
					 elseif (!empty($statusArsip)) {
						?>
						<td><a href="<?php echo site_url('arsip_imb/arsip_detail/'.$enkrip);?>">Pilih</a></td>
						<?php
					}
					...
					*/
						...
						?>
						<td><a href="<?php echo site_url('izin_imb/update/'.$enkrip);?>">Ubah Data</a></td>
						<?php
					}
				   ?>
