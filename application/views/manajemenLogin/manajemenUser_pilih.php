<br /><br />
<fieldset> <legend style="position: static;"><a href="<?php echo site_url('manajemenAkses'); ?>">Manajemen Login User</a> > Pilih Data User</legend>
		...
		?>
		  ...
		  <table class="table table-striped table-hover" style="font-size: 12px; border: 1px inset;" cellpadding="2" cellspacing="1" width="100%">
			...
			<tr style="font-weight: bold;" align="center">
	          ...
	          <a class="btn btn-small" href="<?php echo site_url('manajemenLogin/pilih/'); ?><?php echo '/'.$idUser;?>"><i class="icon-ok-circle"></i> Pilih</a>
		  ...
		  <?php
		    			...
		    			<div class="alert alert-info">
  							...
  							<strong><h4>Maaf !</h4></strong>Data Pegawai Tidak Ada
						</div>
		    			<?php	
		    }
