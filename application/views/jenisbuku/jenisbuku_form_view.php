...
<div class="widget-header widget-header-blue widget-header-flat">
	<h4 class="widget-title lighter">Data Jenis Buku</h4>
	<small>
	...
	<div class="widget-toolbar">
					...
					<div class="row-fluid">
						...
						<form class="form-horizontal" method="POST" action="<?php echo $form_action;?>" role="form" enctype='multipart/form-data'>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="nama">Jenis Buku:</label> 

									<div class="col-sm-9">
										<input type="text" name="nama" id="nama" class="col-xs-10 col-sm-5" placeholder="Jenis Buku" value="<?php echo set_value('nama', isset($default['nama']) ? $default['nama'] : ''); ?>">
					...
					<div class="form-group">
									...
									<div class="col-xs-8 col-sm-9">
											...
											<textarea name="keterangan" placeholder="Keterangan Jenis Buku..."><?php echo set_value('keterangan', isset($default['keterangan']) ? $default['keterangan'] : ''); ?></textarea>
									<!--<p class="error_message">keterangan tidak boleh kosong</p>	-->
