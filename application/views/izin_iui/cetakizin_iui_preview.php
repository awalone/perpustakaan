...
<hr size="2" style="border: double;"/> 
	...
	<div style="font-size:17px">Nomor Seri : &nbsp;&nbsp;&nbsp; 05 &nbsp;/ &nbsp;&nbsp;
...
<a class="btn btn-info" href="<?php echo site_url('cetak_iui');?>" onClick="windowPreview('<?php echo $url_cetak;?>',5,5); this.window.close()">Cetak</a>
