...
<br /><br />
<fieldset> <legend style="position: static;"><a href="<?php echo site_url('rekomendasiImb'); ?>">Izin Usaha Industri</a> > <a href="<?php echo site_url('rekomendasiImb/pilih');?>">Pilih Data Registrasi</a> > Input Data Perizinan (<?php echo $no_reg;?>)</legend>
	...
	<fieldset class="scheduler-border">
		<legend class="scheduler-border">Data Izin Usaha Industri</legend>
  							...
  							<div class="control-group">
    									...
    									<div class="controls">
      										<input type='text' name='nomorRekomendasi' placeholder="NO/KODE/XX/2013" style='font-size: 14px;height: 20px; width: 130px;' id="nomorRekomendasi" value="<?php echo set_value('nomorRekomendasi', isset($default['nomorRekomendasi']) ? $default['nomorRekomendasi'] : ''); ?>">  
	    ...
	    <?php echo form_error('tglRekomendasi', '<p class="field_error">', '</p>'); ?>
						...
						<div class="control-group" style="background:#FFCC66; border-radius: 8px 8px 8px 8px; padding: 8px;">
							...
							<div class="control-group">
    									...
    									<div class="controls">
      										<input type='text' name='investasi' id='kekayaan' style='font-size: 14px;height: 20px; width: 100px;' value="<?php echo set_value('investasi', isset($default['investasi']) ? $default['investasi'] : ''); ?>">
