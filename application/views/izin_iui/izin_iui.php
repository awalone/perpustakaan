 <br /><br />
 <legend style="position: static;"><a href="<?php echo site_url('izinIndustri'); ?>">Izin Usaha Industri</a></legend>
		...
		?>
			...
			<tr style="font-weight: bold;" align="center">
			  ...
			  foreach($query as $row) {
				  ...
				  if (!empty($statusCetak)) {
					?>
						<td><a href="<?php echo site_url('cetak_iui/cetak_detail/'.$enkrip);?>">Cetak</a></td>
					<?php
				  } 
				  
				  elseif (!empty($statusArsip)) {
						?>
						<td><a href="<?php echo site_url('arsip_iui/arsip_detail/'.$enkrip);?>">Pilih</a></td>
						<?php
					}
				...
				/*
					...
					*/
						...
						?>
						<td><a href="<?php echo site_url('izin_iui/update/'.$enkrip);?>">Ubah Data</a></td>
						<?php
					}
				  ?>
		  ...
		  <?php
		    			...
		    			<div class="alert alert-info">
  							...
  							<strong><h4>Maaf !</h4></strong>Data Rekomendasi Izin Usaha Industri Masih Kosong
						</div>
		    			<?php	
		    }
