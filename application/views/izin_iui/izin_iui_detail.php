...
<fieldset style="font-size: 15px;"><legend>Detail Data Izin Usaha Industri</legend>
...
<table width="100%">
	...
	<tr>
		<td colspan="3"><strong>Data Izin Usaha Industri</strong></td>
	</tr>
...
<br /><a class="btn btn-info" href="<?php echo site_url('cetak_iui/cetak');?>">Lihat Surat Izin</a> &nbsp; 
<a class="btn btn-info" href="<?php echo site_url('cetak_iui');?>">Kembali</a> <br /><p></p>
</fieldset>
