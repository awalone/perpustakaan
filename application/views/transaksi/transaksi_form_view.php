...
<div class="widget-header widget-header-blue widget-header-flat">
	...
	<div class="widget-toolbar">
					...
					<div class="row-fluid">
						...
						<form class="form-horizontal" method="POST" action="<?php echo $form_action;?>" role="form">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										<input type="text" name="nip" id="nip" class="col-xs-10 col-sm-1"  data-rel="tooltip" title="" placeholder="NIP" value="<?php echo set_value('nip', isset($default['nip']) ? $default['nip'] : ''); ?>" data-original-title="NIP BARU">
