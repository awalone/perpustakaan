...
<head>
  ...
  <link href="<?=base_url('assets/bootstrap/css/bootstrap-responsive.css'); ?>" rel="stylesheet" type="text/css">
  <link href="<?=base_url('assets/bootstrap/css/yourcontacts.css'); ?>" rel="stylesheet" type="text/css">
  <link href="<?=base_url('assets/bootstrap/css/tablesorter.css'); ?>" rel="stylesheet" type="text/css">
