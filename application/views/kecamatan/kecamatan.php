		  ...
		  <table class="table table-striped table-hover" style="font-size: 12px; border: 1px inset;" cellpadding="2" cellspacing="1" width="100%">
			...
			<tr style="font-weight: bold;" align="center">
			  ...
			  foreach($query as $row) {
			      ...
			      $kodeKecamatan = $row->kd_wil;
			      $namaKecamatan = $row->nm_kec;
				  ...
				  <td>
				      <a class="btn" href="<?php echo site_url("/kecamatan/update/$idKecamatan"); ?>"><i class="icon-refresh"></i>Edit</a>
				      <a class="btn btn-danger" href="<?php echo site_url("/kecamatan/delete/$idKecamatan");?>" onclick="return confirm('Anda Yakin akan Menghapus Data ini?')"><i class="icon-trash icon-white"></i>Hapus</a>
				  </td>
			      </tr>
