 <br /><br />
 <legend style="position: static;"><a href="<?php echo site_url('izin_iup'); ?>">Izin Usaha Perdagangan</a></legend>
	  <div class="static" style="position: relative; overflow: hidden">
		   ...
		   <div class="alert alert-success">
			      				...
			      				<strong>Permohonan Izin Usaha Perdagangan</strong>.
			  </div>
				  ...
				  <td><?php echo $nm_kelurahan;?></td>
				   ...
				   <?php
					if (!empty($statusCetak)) {
						?>
						<td><a href="<?php echo site_url('cetak_siup/cetak_detail/'.$enkrip);?>">Cetak</a> </td>
						<?php
					}
					
					elseif (!empty($statusArsip)) {
						?>
						<td><a href="<?php echo site_url('arsip_iup/arsip_detail/'.$enkrip);?>">Pilih</a></td>
						<?php
					}
					/*
					else {
						?>
						<td><a href="<?php echo site_url('izin_iup/change/'.$enkrip);?>">Ubah Status</a> | <a href="<?php echo site_url('izin_iup/ubahketerangan/'.$enkrip);?>">Keterangan Izin</a></td>
						<?php
					}
					*/
					else {
						?>
						<td><a href="<?php echo site_url('izin_iup/update/'.$enkrip);?>">Ubah Data</a></td>
						<?php
					}
				   ?>
		  ...
		  <?php
			echo $pagination;
		    			...
		    			<div class="alert alert-info">
  							...
  							<strong><h4>Maaf !</h4></strong>Data Rekomendasi Izin Usaha Perdagangan
						</div>
		    			<?php	
		    }
