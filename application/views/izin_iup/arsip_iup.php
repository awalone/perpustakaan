 <legend style="position: static;"><a href="<?php echo site_url('arsip_iup'); ?>">Data Perizinan Usaha Perdagangan</a></legend>
		...
		?>
				  ...
				  <td>
					<?php
						...
						if ($jumlahIzin > 0) {
							...
							?>
								<a class="label label-important" href="<?php echo site_url('arsip_iup/arsip_detail/1/'.$enkrip);?>">Arsip Izin</a> 
							<?php
						}
					?>
					<?php
						...
						if ($jumlahReko > 0) {
							...
							?>
								<a class="label label-important" href="<?php echo site_url('arsip_iup/arsip_detail/0/'.$enkrip);?>">Rekomendasi</a> 
							<?php
						}	
					?>
					...
					<?php
						...
						if ($syarat > 1) {
							?>
								<a class="label label-success" href="<?php echo site_url('arsip_iup/view_arsip/'.$enkrip); ?>">Arsip Lengkap</a> 
							<?php
						} else {
							?>
		  ...
		  <?php
		    			...
		    			<div class="alert alert-info">
  							...
  							<strong><h4>Maaf !</h4></strong>Data Rekomendasi Izin Usaha Perdagangan Masih Kosong
						</div>
		    			<?php	
		    }
