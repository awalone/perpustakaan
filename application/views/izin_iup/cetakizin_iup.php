...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$('.jtextfill2').textfill({ maxFontPixels: 16 });
	});
	$(document).ready(function() {
		$('.jtextfill3').textfill({ maxFontPixels: 16 });
	});
	$(document).ready(function() {
...
<br><br>
                               ...
                               <div align="center" style=" line-height:2; border:1px solid; height:120px; margin-bottom: 3mm; *width: 172mm">
