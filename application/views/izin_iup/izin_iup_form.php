...
<br /><br />
<fieldset> <legend style="position: static;"><a href="<?php echo site_url('izin_iup'); ?>">Izin Usaha Perdagangan</a> > <a href="<?php echo site_url('izin_iup/pilih');?>">Pilih Data Registrasi</a> > Input Data Perizinan (<?php echo $no_reg;?>)</legend>
...
<table width="100%">
	...
	<fieldset class="scheduler-border">
		<legend class="scheduler-border">Data Izin Usaha Perdagangan</legend>
	    ...
	    <?php echo form_error('tglRekomendasi', '<p class="field_error">', '</p>'); ?>
							...
							<div class="control-group">
    									...
    									<div class="controls">
      										<input type='text' id='kekayaan' maxlength='16' name='kekayaan' style='font-size: 14px;height: 20px; width: 130px;' value="<?php echo set_value('kekayaan', isset($default['kekayaan']) ? $default['kekayaan'] : ''); ?>">
	    <?php echo form_error('kekayaan', '<p class="field_error">', '</p>'); ?>
    									</div>
  							</div>
							...
							<div class="control-group">
    									...
    									<div class="controls">
											...
											echo form_dropdown('kategoriUsaha',$kategoriUsaha, $value); ?>
											<?php echo form_error('kategoriUsaha', '<p class="field_error">', '</p>'); ?>
    									</div>
  							</div>
	    ...
	    echo form_dropdown('kelembagaan',$kelembagaan, $value); ?>
		 <?php echo form_error('kelembagaan', '<p class="field_error">', '</p>'); ?>
    									</div>
  							</div>
  							
							
							<div class="control-group">
    									<label class="control-label">Dagangan</label>
    									<div class="controls">
      										<input type='text' name='dagangan' style='font-size: 14px;height: 20px; width: 300px;' value="<?php echo set_value('dagangan', isset($default['dagangan']) ? $default['dagangan'] : ''); ?>">
	    <?php echo form_error('dagangan', '<p class="field_error">', '</p>'); ?>
    									</div>
  							</div>
