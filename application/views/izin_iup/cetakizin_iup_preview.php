...
<!--
<div style="border:#FF0000 0px solid; padding:2px; width: 190mm;">
<div style="border:#FF0000 0px solid; padding:2px; width: 187mm;">
	!-->
<div id="wrap" style="border:#FF0000 0px solid; ">
	<div class="header">
    <span class="logo">
...
<hr size="2" style="border: double;"/> 
	...
	<div id="container">
               ...
               <div align="center" style="line-height: 2; border: solid 1px; height: 120px; margin-bottom: 3mm;
width: 170mm;">
 	<div style="font-size:17px; text-align: left; padding-left: 2mm;width:100%">Nomor Seri : 03 / &nbsp;
    <span style="font-size:17px; font-weight:bold"><?php echo $no_blanko; ?></span>&nbsp;/ <?php echo date('Y'); ?>
</div>
                ...
                <h4>
               	NOMOR: <?php echo strtoupper($no_izin);?>
					...
					<tr class="tModelawal">
                                ...
                                <td colspan="2" valign="top">: <span class="tebal"><?php echo (str_replace("RP","Rp",$kekayaan)) ?>
                                	<br>
                                	<i style="padding-left:2mm"><?php echo "(".ucwords($terbilang)." Rupiah)" ?></i>
                                	</span></td>
			 		</tr>
					<tr class="tModelawal">
					...
					<tr class="tModelawal">
                                ...
                                <div  class="jtextfill1" style="height:30mm">		
                                	: <span class="tebal"><?php echo strtoupper($dagangan); ?></span>
                                </div>	
                                </td>
			 		</tr>                    
					<tr class="tModelawal">
