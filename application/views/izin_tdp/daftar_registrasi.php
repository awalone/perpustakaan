 <legend style="position: static;"><a href="<?php echo site_url('izin_iup'); ?>">Rekomendasi Tanda Daftar Perusahaan</a> > Pilih Data Registrasi</legend><br />
		  ...
		  <table class="table table-striped table-hover" style="font-size: 12px; border: 1px inset;" cellpadding="2" cellspacing="1" width="100%">
			...
			<tr style="font-weight: bold;" align="center">
			  ...
			  foreach($query as $row) {
				  ...
				  <td>
				  <div class="btn-group">
						<a class="btn btn-small" href="<?php echo site_url('izin_tdp/add/'.$id); ?>"><i class="icon-ok-circle"></i> Pilih</a>
	        </div><!-- /btn-group -->
