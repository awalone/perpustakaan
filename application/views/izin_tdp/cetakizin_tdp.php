...
<span style="font-size:15px; font-weight:bold">Nomor Seri: 06 / <?php echo $no_blanko; ?> / <?php echo date("Y");  ?></span>	
<br><br>
	 
			 
<table cellpadding="0" cellspacing="0" style="*width:169mm; width:100%">
			 		<tr>
...
<br>
                    ...
                    <table cellpadding="0" cellspacing="0" style="border-left:1px solid; border-bottom:1px solid; *width:169mm; width:100%">
					<tr class="tModelawal">
                                ...
                                <td valign="middle"  style="width:50mm">STATUS : <span><?php echo strtoupper($all->nm_stausaha); ?></span></td>
			 		</tr>
