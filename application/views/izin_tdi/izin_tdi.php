 ...
 <legend style="position: static;"><a href="<?php echo site_url('izin_tdi'); ?>">Rekomendasi Tanda Daftar Industri</a></legend>
	  <div class="static" style="position: relative; overflow: hidden">
		   ...
		   <div class="alert alert-success">
			      				...
			      				<strong>Permohonan Izin Tanda Daftar Industri</strong>.
			  </div>
		...
		?>
			...
			<tr style="font-weight: bold;" align="center">
			  ...
			  foreach($query as $row) {
				  ...
				  if (!empty($statusCetak)) {
					?>
						<td><a href="<?php echo site_url('cetak_tdi/cetak_detail/'.$enkrip);?>">Cetak</a></td>
					<?php
				  } 
				  
				   elseif (!empty($statusArsip)) {
						?>
						<td><a href="<?php echo site_url('arsip_tdi/arsip_detail/'.$enkrip);?>">Pilih</a></td>
						<?php
					}
				...
				/*
					...
					*/
						...
						?>
						<td><a href="<?php echo site_url('izin_tdi/update/'.$enkrip);?>">Ubah Data</a> </td>
						<?php
					}
				  ?>
		  ...
		  <?php
		    			...
		    			<div class="alert alert-info">
  							...
  							<strong><h4>Maaf !</h4></strong>Data Rekomendasi Izin Tanda Daftar Industri Masih Kosong
						</div>
		    			<?php	
		    }
