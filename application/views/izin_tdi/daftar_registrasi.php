 <br /><br />
 <legend style="position: static;"><a href="<?php echo site_url('izin_tdi'); ?>">Rekomendasi Tanda Daftar Industri</a> > Pilih Data Registrasi</legend><br />
		...
		<?php
			...
			$sent_message = $this->session->flashdata('sent_message');
			if (!empty($sent_message)) {
				?>
								<div class="alert alert-info">
			     				 <a class="close" data-dismiss="alert">x</a>
			      				<strong><?php echo $sent_message;?></strong>.
			  </div>
					<?php	
			}
		  ...
		  <table class="table table-striped table-hover" style="font-size: 12px; border: 1px inset;" cellpadding="2" cellspacing="1" width="100%">
			...
			<tr style="font-weight: bold;" align="center">
			  ...
			  foreach($query as $row) {
				  ...
				  $tgl_registrasi = $this->libraryku->tanggal($row->tgl_reg);
				  ...
				  <td>
				  <div class="btn-group">
						<a class="btn btn-small" href="<?php echo site_url('izin_tdi/add/'.$id); ?>"><i class="icon-ok-circle"></i> Pilih</a>
	        </div><!-- /btn-group -->
