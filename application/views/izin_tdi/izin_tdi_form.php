...
<br /><br />
<fieldset> <legend style="position: static;"><a href="<?php echo site_url('izin_tdi/tampil'); ?>">Rekomendasi Tanda Daftar Industri</a> > <a href="<?php echo site_url('izin_tdi');?>">Pilih Data Registrasi</a> > Input Data Perizinan</legend>
...
<table width="100%">
    ...
    <tr>
	    ...
	    <?php echo form_error('telpBadanUsaha', '<p class="field_error">', '</p>'); ?>
							...
							<div class="control-group">
    									...
    									<div class="controls">
      										<input type='text' id='fax' name='fax' style='font-size: 14px;height: 20px; width: 200px;'value="<?php echo $noFax; ?>">
	    <?php echo form_error('fax', '<p class="field_error">', '</p>'); ?>
  							...
  							<div class="control-group">
    									...
    									<div class="controls">
      										<input type='text' disabled name='jabatanPemohon' style='font-size: 14px;height: 20px; width: 300px;' value="<?php echo $jab_pengurus; ?>">
	...
	<fieldset class="scheduler-border">
		<legend class="scheduler-border">Data Tanda Daftar Industri</legend>
	    ...
	    <?php echo form_error('tglRekomendasi', '<p class="field_error">', '</p>'); ?>
							...
							<div class="control-group">
    									...
    									<div class="controls">
      										<input type='text' id='kekayaan' name='investasi' style='font-size: 14px;height: 20px; width: 100px;' value="<?php echo set_value('investasi', isset($default['investasi']) ? $default['investasi'] : ''); ?>">
	    <?php echo form_error('investasi', '<p class="field_error">', '</p>'); ?>
  							...
  							<div class="control-group">
    									...
    									<div class="controls">
      										<input type='text' id='kapasitas' name='kapasitasProduksi' style='font-size: 14px;height: 20px; width: 500px;' value="<?php echo set_value('kapasitasProduksi', isset($default['kapasitasProduksi']) ? $default['kapasitasProduksi'] : ''); ?>">
	    <?php echo form_error('kapasitasProduksi', '<p class="field_error">', '</p>'); ?>
							...
							<div class="control-group">
    									...
    									<div class="controls">
      										<input type='text' id='jumlah' name='jumlahTenagaKerja' style='font-size: 14px;height: 20px; width: 100px;' value="<?php echo set_value('jumlahTenagaKerja', isset($default['jumlahTenagaKerja']) ? $default['jumlahTenagaKerja'] : ''); ?>"> Orang
