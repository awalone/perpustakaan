 	 <br /><br />
 <legend style="position: static;"><a href="<?php echo site_url('manajemenUser'); ?>">Manajemen User</a></legend>
		  ...
		  <table class="table table-striped table-hover" style="font-size: 12px; border: 1px inset;" cellpadding="2" cellspacing="1" width="100%">
			...
			<tr style="font-weight: bold;" align="center">
	          ...
	          <ul class="dropdown-menu">
	            <li><a href="<?php echo site_url("/manajemenUser/update/$idUser");?>"><i class="icon-pencil"></i> Edit</a></li>
	            <li><a href="<?php echo site_url("/manajemenUser/delete/$idUser");?>" onClick="return confirm('Anda yakin..???');"><i class="icon-trash"></i> Hapus Data</a></li>
	          </ul>
	        </div><!-- /btn-group -->
