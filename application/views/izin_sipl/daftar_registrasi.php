 <br /><br />
 <legend style="position: static;"><a href="<?php echo site_url('izin_sipl'); ?>">Izin Penyelenggaraan Latihan</a> > Pilih Data Registrasi</legend><br />
		   ...
		   <div class="alert alert-success">
			      				...
			      				<strong>Permohonan Izin Penyelenggaraan Latihan</strong>.
			  </div>
		<?php
		...
		?>
		  ...
		  <table class="table table-striped table-hover" style="font-size: 12px; border: 1px inset;" cellpadding="2" cellspacing="1" width="100%">
			...
			<tr style="font-weight: bold;" align="center">
			  ...
			  foreach($query as $row) {
				  ...
				  <td>
				  <div class="btn-group">
						<a class="btn btn-small" href="<?php echo site_url('izin_sipl/add/'.$id); ?>"><i class="icon-ok-circle"></i> Pilih</a>
	        </div><!-- /btn-group -->
		  ...
		  <?php
		    			...
		    			<div class="alert alert-info">
  							...
  							<strong><h4>Maaf !</h4></strong>Data Registrasi Izin Penyelenggaraan Latihan Masih Kosong
						</div>
		    			<?php	
		    }
