 <legend style="position: static;"><a href="<?php echo site_url('arsip_sipl'); ?>">Data Perizinan Penyelenggaraan Latihan</a></legend>
				  ...
				  <td>
					<?php
						...
						if ($jumlahIzin > 0) {
							...
							?>
								<a class="label label-important" href="<?php echo site_url('arsip_sipl/arsip_detail/1/'.$enkrip);?>">Arsip Izin</a> 
							<?php
						}
					?>
					<?php
						...
						if ($jumlahReko > 0) {
							...
							?>
								<a class="label label-important" href="<?php echo site_url('arsip_sipl/arsip_detail/0/'.$enkrip);?>">Rekomendasi</a> 
							<?php
						}	
					?>
					...
					<?php
						...
						if ($syarat > 1) {
							?>
								<a class="label label-success" href="<?php echo site_url('arsip_sipl/view_arsip/'.$enkrip); ?>">Arsip Lengkap</a> 
							<?php
						} else {
							?>
