 <br /><br />
 <legend style="position: static;"><a href="<?php echo site_url('izin_sipl'); ?>">Rekomendasi Izin Penyelenggaraan Latihan</a></legend>
		...
		?>
			  ...
			  foreach($query as $row) {
				 ...
				 <?php
				  if (!empty($statusCetak)) {
					?>
						<td><a href="<?php echo site_url('cetak_sipl/cetak_detail/'.$enkrip);?>">Cetak</a></td>
					<?php
				  } /*
					else {
						?>
					...
					*/
						...
						?>
						<td><a href="<?php echo site_url('izin_sipl/update/'.$enkrip);?>">Ubah Data</a></td>
						<?php
					}
				  ?>
		  ...
		  echo $pagination;
		    			...
		    			<div class="alert alert-info">
  							...
  							<strong><h4>Maaf !</h4></strong>Data Izin Penyelenggaraan Latihan Masih Kosong
						</div>
		    			<?php	
		    }
			...
			{
				?>
				<a href='<?php echo $back;?>'>Kembali</a>
				<?php
			}
