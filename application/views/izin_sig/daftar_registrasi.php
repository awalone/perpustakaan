<br /><br /> 
 <legend style="position: static;">Pilih Data Registrasi Izin Gangguan</legend>
 <br />
		  ...
		  <table class="table table-striped table-hover" style="font-size: 12px; border: 1px inset;" cellpadding="2" cellspacing="1" width="100%">
			...
			<tr style="font-weight: bold;" align="center">
			  ...
			  foreach($query as $row) {
				  ...
				  <td>
				  <div class="btn-group">
						<a class="btn btn-small" href="<?php echo site_url('izin_sig/add/'.$id); ?>"><i class="icon-ok-circle"></i> Pilih</a>
	        </div><!-- /btn-group -->
		  ...
		  <?php
				if (!empty($pagination)) echo $pagination;
		    			...
		    			<div class="alert alert-info">
  							...
  							<strong><h4>Maaf !</h4></strong>Data Registrasi Izin Gangguan Masih Kosong
						</div>
		    			<?php	
		    }
