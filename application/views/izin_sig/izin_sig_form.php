...
<br /><br />
<fieldset> <legend style="position: static;"><a href="<?php echo site_url('izin_sig/tampil'); ?>">Rekomendasi Izin Gangguan</a> > <a href="<?php echo site_url('izin_sig');?>">Pilih Data Registrasi</a> > Input Data Perizinan (<?php echo $no_reg;?>)</legend>
...
<table width="100%">
    ...
    <tr>
		...
		<div class="control-group">
    									...
    									<div class="controls">
											...
											<input type='hidden' name='namaBadanUsaha' value='<?php echo $nm_bdnusaha;?>' />
		 ...
		 <?php echo form_error('stausaha', '<p class="field_error">', '</p>'); ?>
  							...
  							<div class="control-group">
    									...
    									<div class="controls">
											...
											<input type='hidden' name='alamatBadanUsaha' value='<?php echo $alm_bdnusaha;?>' />
	    ...
	    <?php echo form_error('jabatanPemohon', '<p class="field_error">', '</p>'); ?>
							...
							<div class="control-group">
    									...
    									<div class="controls">
      										<input type='text' id='number' name='telpBadanUsaha' style='font-size: 14px;height: 20px; width: 200px;' value="<?php echo $tlp_bdnusaha;?>">
	    <?php echo form_error('telpBadanUsaha', '<p class="field_error">', '</p>'); ?>
							...
							<div class="control-group">
    									...
    									<div class="controls">
      										<input type='text' id='fax' name='noFax' style='font-size: 14px;height: 20px; width: 200px;' value="<?php echo $noFax; ?>">
	    <?php echo form_error('noFax', '<p class="field_error">', '</p>'); ?>
    									</div>
  							</div>
	...
	<fieldset class="scheduler-border">
		<legend class="scheduler-border">Data Izin Gangguan</legend>
  							...
  							<div class="control-group">
    									...
    									<div class="controls">
      										<input type='text' name='nomorRekomendasi' placeholder="NO/KODE/XX/2013" style='font-size: 14px;height: 20px; width: 130px;' value="<?php echo set_value('nomorRekomendasi', isset($default['nomorRekomendasi']) ? $default['nomorRekomendasi'] : ''); ?>">  
	    ...
	    <?php echo form_error('tglRekomendasi', '<p class="field_error">', '</p>'); ?>
							...
							<div class="control-group">
    									...
    									<div class="controls">
      										<input type='text' id='number' name='kapasitas' maxlength="4" style='font-size: 14px;height: 20px; width: 50px;' value="<?php echo set_value('kapasitas', isset($default['kapasitas']) ? $default['kapasitas'] : ''); ?>"> orang
	    <?php echo form_error('kapasitas', '<p class="field_error">', '</p>'); ?>
    									</div>
  							</div>
							...
							<div class="control-group">
    									...
    									<div class="controls">
      										<input type='text' id='number' name='tenagaKerja' maxlenght="4" style='font-size: 14px;height: 20px; width: 50px;' value="<?php echo set_value('tenagaKerja', isset($default['tenagaKerja']) ? $default['tenagaKerja'] : ''); ?>"> orang
	    <?php echo form_error('tenagaKerja', '<p class="field_error">', '</p>'); ?>
    									</div>
  							</div>
							
  							<div class="control-group">
    									<label class="control-label">Luas Tempat Usaha</label>
    									<div class="controls">
      										<input type='text' name='luasTempatUsaha' id='number' maxlength="6" style='font-size: 14px;height: 20px; width: 50px;' value="<?php echo set_value('luasTempatUsaha', isset($default['luasTempatUsaha']) ? $default['luasTempatUsaha'] : ''); ?>"> m2
	    <?php echo form_error('luasTempatUsaha', '<p class="field_error">', '</p>'); ?>
    									</div>
  							</div>
							...
							<div class="control-group">
    									...
    									<div class="controls">
      										<input type='text' name='golongan' style='font-size: 14px;height: 20px; width: 50px;' value="<?php echo set_value('golongan', isset($default['golongan']) ? $default['golongan'] : ''); ?>">
