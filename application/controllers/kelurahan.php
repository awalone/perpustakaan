<?php
	...
	{	
		function __construct()
		{
			...
			$this->load->model('kelurahan_model','kelurahan',TRUE);
			
			
		}
		var $title = 'Ref. Kelurahan';
		var $limit = 5;
		...
		function get_all()
		{
			...
			$data['h2_title'] = 'Referensi Kelurahan';
			$data['main_view'] = 'kelurahan';
			$data['search']	= site_url('kelurahan/search_process');
			//offset
			...
			$data['query']  = $this->kelurahan->get_all($this->limit,$offset)->result();
			$data['jumlah'] = $this->kelurahan->get_all_data();
			$config['base_url'] = base_url() . 'kelurahan/get_all/';
    ...
    $config['per_page'] = $this->limit;
     ...
     $this->pagination->initialize($config);
		 $data["paginator"] =$this->pagination->create_links();
			...
			$data['link'] = site_url('kelurahan/add');
			$data['kembali'] = "";
			$data['export'] = site_url('kelurahan/export');
			$data['import'] = site_url('kelurahan/import');
