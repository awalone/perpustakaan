...
class CI_DB_mysql_driver extends CI_DB {
	...
	function db_connect_mysqli($db)
	{
		...
		return mysqli_connect($this->hostname, $this->username, $this->password,$db);
	}
	...
	function execute_multi_query($sql) {
...
*/
		...
		$link = $this->db_connect_mysqli('kpap');
